...
gridOptions = {
    ...
    'columnDefs': [
        ...
        {'headerName': 'MGE2', 'field': 'MGE2', 'maxWidth':68, 'headerClass': 'group-header-center', 'suppressMovable':'true',
         ...
         "sortable": True,
         "sortComparator": "function(a, b, nodeA, nodeB, isInverted) { return nodeA.data.VPE - nodeB.data.VPE; }"},     
        {'headerName': 'MGE Tot.', 'field': 'MGE_Tot', 'maxWidth':70, 'headerClass': 'group-header-center', 'suppressMovable':'true',
         'cellStyle': {'textAlign': 'center', 'verticalAlign': 'middle', 'line-height': '1', 'fontSize': '12px'},
        ...
        {'headerName': 'GE Tot.', 'field': 'GE_Tot', 'maxWidth':70, 'headerClass': 'group-header-center', 'cellClass': 'custom-border-right', 'suppressMovable':'true',
         'cellStyle': {'textAlign': 'center', 'verticalAlign': 'middle', 'line-height': '1', 'fontSize': '12px'},
