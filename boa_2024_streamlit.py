...
gridOptions = {
    ...
    'columnDefs': [
        ...
        {'headerName': 'Ind.', 'field': 'MPI', 'width':90, 'type': 'rightAligned',
        ...
        {'headerName': 'Ens.', 'field': 'MPE', 'width':90, 'type': 'rightAligned',
        ...
        {'headerName': 'Avg.', 'field': 'Mus_Avg', 'width':90, 'type': 'rightAligned', "cellStyle": {"border-right": "4px solid #FF0000"}, 
        ...
        {'headerName': 'Ensemble', 'field': 'VPE', 'width':90,
        ...
        {'headerName': 'Average', 'field': 'Vis_Avg', 'width':90, "cellStyle": {"border-right": "4px solid #FF0000"},
         ...
         "sortable": True,
         "sortComparator": "function(a, b, nodeA, nodeB, isInverted) { return nodeA.data.Vis_Avg - nodeB.data.Vis_Avg; }"}], 'headerClass':'center-header-group'},
